...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_TESTSTANDARD']._serialized_start=997
  _globals['_TESTSTANDARD']._serialized_end=1096
  ...
  _globals['_TESTREPORT']._serialized_end=995
