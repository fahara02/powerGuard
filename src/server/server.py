...
# class Server:
#     def __init__(self, host="0.0.0.0", port=12345, node_red_dir="node-red"):
#         self.host = host
#         self.port = port
#         self.node_red_dir = node_red_dir
#         self.server_socket = None
#         self.install_node_red_if_needed()  # Check and install Node-RED during initialization
...
class Server:
    ...
    def install_node_red_palette(self):
        ...
        try:
            ...
            print(f"Failed to install Node-RED palette: {e}")
            exit(1)
